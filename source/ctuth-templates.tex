...
\ctutemplateset{titlepage}{
	...
	\vbox to \dimexpr\textheight + \baselineskip + \headsep + \footskip{
		...
		% 	\includegraphics[ height=\dimexpr4\normalbaselineskip-1ex ] {ctu_logo_black}
		% &
		% 	\begin{tabular} [b] { @{} l @{} }
		% 	        \Large \color{ctubluetext} \ctufield[title]{university} \\[4pt]
		% 	        \ctufield[title]{faculty} \\[2pt]
		% 	        \ctufield[title]{department}
		% 	\end{tabular}
		% \end{tabular}\par
                \hspace*{3pt}
                \includegraphics[ height=2cm ] {symbol_cvut_konturova_verze}
		\hspace*{1em}
		\begin{minipage}{\linewidth}
		        \vskip-45pt
		        \begin{tabular} [b] {  l }
		                
			        \color{ctubluetext} \Large \ctufield[title]{university} \\[0.3cm]
			        \ctufield[title]{faculty} \\[0.15cm]
			        \ctufield[title]{department} \\
		        \end{tabular} 
		\end{minipage} 
		\par
		...
		\parskip 1pt
		\ctuiffield*[title]{fieldofstudy} {\fieldofstudyname : \par
		                                   \hspace{5ex}  \ctufield[title]{fieldofstudy } 
		                                   \hspace{1ex} \textcolor{gray}{ \fieldofstudyRealEngl} \par } {}
		\ctuiffield*[title]{subfieldofstudy}{\subfieldofstudyname : \par
		                                     \mbox{\hspace{5ex} \ctufield[title]{subfieldofstudy} 
		                                           \hspace{1ex} \textcolor{gray}{ \subfieldofstudyRealEngl} } \par } {}
	        \ctuiffield*{supervisor}{\supervisorname : \par
		                         \hspace{5ex}       {\frenchspacing\ctufield{supervisor}}\par} {}
		\ctuiffield*{supervisor-specialist}{\supervisorspecialistname : \par
		                                    {\frenchspacing\ctufield{supervisor-specialist}}\par} {}
		\bigskip
...
\ctutemplateset{twocolumn.abstract.in.titlelanguage}{
		...
		\ctufield[title]{keywords} \paragraph
		% {\supervisorname :}
