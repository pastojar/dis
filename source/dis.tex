...
\usepackage{pdfpages}      % to include external pdf
...
\ctusetup{
    ...
    title-czech = {Experimentální vyhodnocení srážkových měření z~komerčních mikrovlnných spojů pro~srážko-odtokové modelování v~malém městském povodí},
    ...
    keywords-english = {commercial microwave links, rainfall-runoff modelling, uncertainties, urban hydrology, wet-antenna attenuation},
    keywords-czech = {komerční mikrovlnné spoje, městská hydrologie, nejistoty, srážko-odtokové modelování, útlum na mokré anténě}
}
...
\chapterstarmark{5. Assesing CML QPEs by quantifying uncertainties ... : The~pilot~study}
...
\chapterstarmark{8. Assesing CML QPEs by quantifying uncertainties ... : The~final~study}
...
\includepdf[pages=-]{figs/App/hydro+stats_Pre remRGs_mean 1min EDITED.pdf}
\includepdf[pages=-]{figs/App/hydro+stats_Pre CMLQPEs WAA_remRGs_mean60 EDITED.pdf}
