...
\begin{itemize}
        ...
        \item 60-min data from a municipal rain gauge located at the Prague central waste water treatment plant in an 8-km distance to the south-west from the catchment (Fig.~\ref{3fig2}).
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=14cm]{figs/paperIII/Scatter.png}
\caption{Scatter.} 
\label{fig:III_2}
\end{center}
\end{figure}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=12cm]{figs/paperIII/hydrograph.png}
\caption{Hydrograph.} 
\label{fig:III_3}
\end{center}
\end{figure}
