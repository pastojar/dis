...
\def\ctucaptionsenglish{
	...
	\def\supervisorname{Thesis\ Tutor}
	%\def\supervisorspecialistname{Supervisor--specialist}
	\def\supervisorspecialistname{Tutor--specialist}
	\def\fieldofstudyname{Doctoral\ study\ programme}
	\def\subfieldofstudyname{Branch\ of\ study}
